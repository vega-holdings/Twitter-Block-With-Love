...
(_ => {
  ...
  */
  ...
  async function fetch_followers(userName, count) {
    ...
    const response = await ajax.get(`https://x.com/i/api/graphql/${followersId}/Followers?variables=%7B%22userId%22%3A%22${userId}%22%2C%22count%22%3A${count}%2C%22includePromotedContent%22%3Afalse%7D&${paramsExtREQ}`);
